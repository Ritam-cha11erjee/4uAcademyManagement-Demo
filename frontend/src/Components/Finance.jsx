...
const Finance = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:3000/finances/financial-summary').then(
    ...
    const handleUpdateStats = async () => {
        ...
        try {
            await axios.post('http://localhost:3000/finances/update-monthly-stats', {
                monthYear,
            ...
            //Refresh the table
            const res = await axios.get('http://localhost:3000/finances/financial-summary');
